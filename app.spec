# Two launchers share one directory. Native engines and models stay outside.
...
pyz = PYZ(a.pure)
cli = EXE(pyz, a.scripts, [], exclude_binaries=True, name='asr2rpp', console=True, upx=False)
