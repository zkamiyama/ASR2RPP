...
class StagePanel(QFrame):
    ...
    def __init__(self, task: str, optional: bool, ui_lang: str):
        ...
        grid.addWidget(self.params, 0, 4)
        ...
        grid.addWidget(self.language, 1, 3, 1, 2)
        ...
        grid.addWidget(self.reference_label, 2, 0)
        grid.addWidget(self.reference, 2, 1, 1, 4)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.language_button.setObjectName("iconButton")
        ...
        self.run_button.setIconSize(QSize(17, 17))
